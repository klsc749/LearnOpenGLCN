...
void main()
{
	...
	float attenuation = 1.0 / (u_light.constant + u_light.linear *
		distance + u_light.quadratic * distance * distance);
	...
	vec3 res = (ambient+ diffuse + specular) * attenuation * u_objColor;
